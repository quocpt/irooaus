...
class CarBatteryController: UIViewController, UITextFieldDelegate,MFMailComposeViewControllerDelegate {
    ...
    @IBAction func button_pressed(_ sender: Any) {
        if let phoneCallURL = URL(string: "tel://1300150131") {
    ...
    override func viewDidLoad() {
        ...
        //Add RETURN to ROOT button
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "RESET", style: .plain, target: self, action: #selector(addTapped))
